...
urlpatterns = [
    ...
    # Providers
    url(r'^providers/$', login_required(views.ProviderListView.as_view()), name='provider_list'),
    ...
    # Circuit types
    url(r'^circuit-types/$',
        login_required(views.CircuitTypeListView.as_view()), name='circuittype_list'),
    ...
    # Circuits
    url(r'^circuits/$', login_required(views.CircuitListView.as_view()), name='circuit_list'),
    ...
    url(r'^circuits/(?P<circuit>\d+)/terminations/add/$',
        login_required(views.CircuitTerminationCreateView.as_view()), name='circuittermination_add'),
