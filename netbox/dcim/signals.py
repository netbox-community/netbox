...
def sync_cached_scope_fields(instance, created, **kwargs):
    ...
    for model in (Prefix, Cluster, WirelessLAN):
        ...
        # signals, avoiding spurious change log entries. order_by() clears the model's
        # default ordering, which would otherwise be included in the DISTINCT and defeat
        # the grouping.
        for scope_type_id, scope_id in qs.values_list('scope_type_id', 'scope_id').order_by().distinct():
