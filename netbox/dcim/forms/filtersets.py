...
class SiteFilterForm(TenancyFilterForm, ContactModelFilterForm, NetBoxModelFilterSetForm):
    ...
    selector_fields = ['region_id', 'group_id',]
...
class RackFilterForm(TenancyFilterForm, ContactModelFilterForm, NetBoxModelFilterSetForm):
    ...
    selector_fields = ['region_id', 'site_group_id', 'site_id', 'location_id',]
    region_id = DynamicModelMultipleChoiceField(
        queryset=Region.objects.all(),
        required=False,
        label=_('Region')
...
class DeviceTypeFilterForm(NetBoxModelFilterSetForm):
    ...
    selector_fields = ['manufacturer_id',]
...
class DeviceFilterForm(
    ...
    selector_fields = ['region_id', 'site_group_id', 'site_id', 'location_id', 'rack_id',]
    region_id = DynamicModelMultipleChoiceField(
        queryset=Region.objects.all(),
        required=False,
        label=_('Region')
...
class PowerPanelFilterForm(ContactModelFilterForm, NetBoxModelFilterSetForm):
    ...
    selector_fields = ['site_id', 'location_id',]
    region_id = DynamicModelMultipleChoiceField(
        queryset=Region.objects.all(),
        required=False,
        label=_('Region')
