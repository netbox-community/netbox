...
router.register('cooling-port-templates', views.CoolingIntakeTemplateViewSet)
router.register('cooling-outlet-templates', views.CoolingOutflowTemplateViewSet)
...
router.register('cooling-ports', views.CoolingIntakeViewSet)
router.register('cooling-outlets', views.CoolingOutflowViewSet)
