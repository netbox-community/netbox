...
urlpatterns = [
    ...
    # VRFs
    url(r'^vrfs/$', login_required(views.VRFListView.as_view()), name='vrf_list'),
    ...
    # RIRs
    url(r'^rirs/$', login_required(views.RIRListView.as_view()), name='rir_list'),
    ...
    # Aggregates
    url(r'^aggregates/$', login_required(views.AggregateListView.as_view()), name='aggregate_list'),
    ...
    # Roles
    url(r'^roles/$', login_required(views.RoleListView.as_view()), name='role_list'),
    ...
    # Prefixes
    url(r'^prefixes/$', login_required(views.PrefixListView.as_view()), name='prefix_list'),
    ...
    # IP addresses
    url(r'^ip-addresses/$', login_required(views.IPAddressListView.as_view()), name='ipaddress_list'),
    ...
    # VLAN groups
    url(r'^vlan-groups/$', login_required(views.VLANGroupListView.as_view()), name='vlangroup_list'),
    ...
    # VLANs
    url(r'^vlans/$', login_required(views.VLANListView.as_view()), name='vlan_list'),
    ...
    # Services
    url(r'^services/(?P<pk>\d+)/edit/$',
            login_required(views.ServiceEditView.as_view()), name='service_edit'),
