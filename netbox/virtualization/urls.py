...
urlpatterns = [
    ...
    # Cluster types
    url(r'^cluster-types/$',
        login_required(views.ClusterTypeListView.as_view()), name='clustertype_list'),
    ...
    # Cluster groups
    url(r'^cluster-groups/$',
        login_required(views.ClusterGroupListView.as_view()), name='clustergroup_list'),
    ...
    # Clusters
    url(r'^clusters/$', login_required(views.ClusterListView.as_view()), name='cluster_list'),
    ...
    # Virtual machines
    url(r'^virtual-machines/$',
        login_required(views.VirtualMachineListView.as_view()), name='virtualmachine_list'),
    ...
    # VM interfaces
    url(r'^virtual-machines/interfaces/add/$',
        login_required(views.VirtualMachineBulkAddInterfaceView.as_view()), name='virtualmachine_bulk_add_interface'),
